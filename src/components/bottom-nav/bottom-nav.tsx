...
const HomeIcon = () => (
	...
	>
		<path
			d="M3 9.5L12 3l9 6.5V21a1 1 0 01-1 1h-5a1 1 0 01-1-1v-5a1 1 0 00-1-1h-2a1 1 0 00-1 1v5a1 1 0 01-1 1H4a1 1 0 01-1-1V9.5z"
			strokeLinecap="round"
...
export default function BottomNav() {
	...
	const pageItems = [
		...
		}, // Lavender
		{
			...
			external: false,
			color: "#FFB58D",
			shadow: "rgba(255, 181, 141, 0.4)",
			darkIcon: false
		} // Soft peach/coral orange
	];
	...
	const socialItems = [
		{
			Icon: LinkedInIcon,
			label: "LinkedIn",
			tooltip: "sara-lahrach",
			href: "https://www.linkedin.com/in/sara-lahrach/",
			external: true,
			color: "#7DD3FC",
		...
		}, // Sky blue
		{
			...
			label: "GitHub",
			tooltip: "@slahrach",
			href: "https://github.com/slahrach",
			external: true,
			color: "#FFF389",
			shadow: "rgba(255, 246, 165, 0.4)",
			darkIcon: true
		}, // Cold pastel yellow
		{
			Icon: MailIcon,
			label: "Email",
			tooltip: "slahrach.me",
			href: "mailto:slahrach.me@gmail.com",
			external: true,
			color: "#5EEAD4",
			...
			<div className="relative">
				...
				<button
					...
					style={{
						...
						borderRadius: "15px",
						background: isActive || isHovered ? item.color : "transparent",
						border:
							isActive || isHovered
								? "none"
			...
			>
				<div className="flex gap-2.5 items-center">
					...
					{socialItems.map((item, index) => (
						<NavButton
							key={index + pageItems.length}
							item={item}
							globalIndex={index + pageItems.length}
						/>
					))}
				</div>
			</div>
